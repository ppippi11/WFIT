...
ProcedureC OpenCV(ImageFile.s,folder$)
...
; 
;               EndIf
            cvSaveImage("after_thinning", *color, #Null)
            EndIf
            ; exitCV = #True
           ;  cvSaveImage(folder$+"\test2.png", *color, #Null)
...
; 
;         OpenCV(GetImage())
;         SaveImage(FileName, "test.png", #PB_ImagePlugin_PNG)
; 
;       EndIf
; 
;     Else
; 
;       MessageBox_(0, ImageFile + Chr(10) + Chr(10) + "... does not meet the size requirements, please try another image.", #CV_WINDOW_NAME, #MB_ICONERROR)
; 
;       cvReleaseImage(@*resize)
; 
;       cvReleaseImage(@*image)
...
;ExamineDesktops()
;OpenCV("images/111.jpg","images")
;OpenCV("C:\Users\yunhee\Desktop\²æ\AC01\test.png")
